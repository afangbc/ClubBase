...
import { GRADES, SEED_PASSWORD, homeFor, type Role } from "@/lib/campus-data";
                  ...
                  <div className="mt-2 grid gap-1.5">
                    {demoLogins.map((demo) => (
                      <button
                        ...
                        className="rounded-md px-2 py-1.5 text-left text-xs text-secondary-foreground transition-colors hover:bg-background"
                      >
